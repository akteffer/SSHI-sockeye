...
### Updated SSHI sockeye exploratory analyses (stage 1)
#### by B. Connors
##### revised by A. Teffer 
...
Updated data from Steve Latham at PSC: (productiondata(by_stock)VERYprel-20mailout(Oct02_20).xlsx). -> all integrated into "fraser_brood_table_210528.txt" in data folder by BC. 5 year old recruits for 2016 brood year were estimated for all stocks based on stock-specific average proportion of 5 year old recruits. 
