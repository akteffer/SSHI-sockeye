...
pdf(file="C:/Users/artie/OneDrive/PBS_postdoc/sockeye/sock_lwr_mar18_21.pdf",width=11,height=8.5,paper="USr")
...
### step 8: inference ###
b_est = postpack::post_summ(post, "B|b",p_summ=c(0.5,0.025,0.25,0.4,0.6,0.75,0.95))
b2_est = postpack::post_summ(post, "B2|b2",p_summ=c(0.5,0.025,0.25,0.4,0.6,0.75,0.95))
b3_est = postpack::post_summ(post, "B3|b3",p_summ=c(0.5,0.025,0.25,0.4,0.6,0.75,0.95))
...
b1<-post_subset(post,p="B2|b2",matrix=T)
